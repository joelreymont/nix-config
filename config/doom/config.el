...
(after! sly
  (setq sly-lisp-implementations
        '((allegro ("/Applications/AllegroCL64SMP.app/Contents//Resources/alisp"))
...
(add-hook! emacs-lisp-mode #'my-lisp-mode-hook)
...
(with-eval-after-load 'lisp-mode
  ...
  (define-key lisp-mode-map (kbd "M-RET '") 'slime-connect-default))
